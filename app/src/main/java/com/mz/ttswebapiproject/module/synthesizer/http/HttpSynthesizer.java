package com.mz.ttswebapiproject.module.synthesizer.http;
 ...
 */
public class HttpSynthesizer implements DataSynthesizer {
    private Call call;
    public void startPost(final String requestContent, final int index) {
        ...
        if(TextUtils.isEmpty(base64AudioStr)){
            return;
        }
